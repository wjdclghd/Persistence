...
/// Since Persistence is a static framework, the bundle containing the resources is copied into the final product.
    static let module: Bundle = {
        let bundleName = "Persistence_Persistence"
        ...
        fatalError("unable to find bundle named Persistence_Persistence")
    }()
}
