...
@objc(SessionSnapshotManagedObject)
final class SessionSnapshotManagedObject: NSManagedObject {
...
extension SessionSnapshotManagedObject {
    /// SessionSnapshot 엔티티용 typed fetch request를 생성합니다.
    ///
    /// - Returns: SessionSnapshot 엔티티를 조회하는 NSFetchRequest
    @nonobjc class func fetchRequest() -> NSFetchRequest<SessionSnapshotManagedObject> {
        NSFetchRequest<SessionSnapshotManagedObject>(entityName: "SessionSnapshot")
    }
}
