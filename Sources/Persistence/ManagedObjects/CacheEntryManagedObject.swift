...
@objc(CacheEntryManagedObject)
final class CacheEntryManagedObject: NSManagedObject {
...
extension CacheEntryManagedObject {
    /// CacheEntry 엔티티용 typed fetch request를 생성합니다.
    ///
    /// - Returns: CacheEntry 엔티티를 조회하는 NSFetchRequest
    @nonobjc class func fetchRequest() -> NSFetchRequest<CacheEntryManagedObject> {
        NSFetchRequest<CacheEntryManagedObject>(entityName: "CacheEntry")
    }
}
