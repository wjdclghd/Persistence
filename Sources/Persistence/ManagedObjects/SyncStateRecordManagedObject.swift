...
@objc(SyncStateRecordManagedObject)
final class SyncStateRecordManagedObject: NSManagedObject {
...
extension SyncStateRecordManagedObject {
    /// SyncStateRecord 엔티티용 typed fetch request를 생성합니다.
    ///
    /// - Returns: SyncStateRecord 엔티티를 조회하는 NSFetchRequest
    @nonobjc class func fetchRequest() -> NSFetchRequest<SyncStateRecordManagedObject> {
        NSFetchRequest<SyncStateRecordManagedObject>(entityName: "SyncStateRecord")
    }
}
