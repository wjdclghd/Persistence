...
/*
 SyncStateRecord와 SyncStateRecordMO 사이의 변환을 담당하는 Mapper입니다.

 Persistence API는 SyncStateRecord를 외부 계약으로 사용하고,
 Core Data 저장 계층은 SyncStateRecordMO를 사용합니다.
...
enum SyncStateRecordMapper {
    /*
     ...
     Returns:
     - SyncStateRecord 값 객체
     */
    static func toRecord(
        _ managedObject: SyncStateRecordMO
    ) -> SyncStateRecord {
        SyncStateRecord(
    ...
    /*
     ...
     Returns:
     - 삽입된 SyncStateRecord ManagedObject
     */
    static func insert(
        from record: SyncStateRecord,
